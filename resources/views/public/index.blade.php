...
@include('public.partials.guest-home-banner')
@endif
...
<section id="search-properties" class="bg-white py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-[#96A480] text-white p-4 rounded-t-lg">
            <div class="flex items-center justify-center">
                <h2 class="text-lg font-bold uppercase">SEARCH PROPERTIES</h2>
        ...
        <form action="{{ route('home') }}" method="GET" class="bg-white border border-gray-200 border-t-0 rounded-b-lg p-6">
            ...
            <div class="flex border-b border-gray-200 mb-6">
                <button type="button" onclick="switchSearchTab('sale')" class="search-tab flex-1 py-3 px-4 text-sm font-semibold bg-[#96A480] text-white" data-tab="sale">
                    REAL ESTATE FOR SALE
                </button>
                <button type="button" onclick="switchSearchTab('rental')" class="search-tab flex-1 py-3 px-4 text-sm font-semibold bg-white text-gray-700 hover:bg-gray-50" data-tab="rental">
                    LONG TERM RENTALS
                </button>
                <button type="button" onclick="switchSearchTab('keyword')" class="search-tab flex-1 py-3 px-4 text-sm font-semibold bg-white text-gray-700 hover:bg-gray-50" data-tab="keyword">
                    KEYWORD SEARCH
                </button>
            </div>
            --}}
                ...
                <div>
                    ...
                    <select name="property_type" class="w-full border border-gray-300 rounded px-3 py-2">
                        ...
                        @if(isset($propertyTypes))
                            ...
                            @endforeach
                        @else
                            {{-- Fallback if variable is missing (e.g. cached view issues) --}}
            ...
            <!-- Second Row (Removed as merged into first) -->
            ...
            <div class="mb-4">
                ...
                <div id="advanced-search-content" class="hidden border border-gray-200 border-t-0 rounded-b-lg p-4 bg-gray-50">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Search by PN NUMBER</label>
                            <input type="text" name="property_number" value="{{ request('property_number') }}" placeholder="Enter PN NUMBER" class="w-full border border-gray-300 rounded px-3 py-2">
                        </div>
                        <div>
