    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('admin.tags.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-[#96A480] focus:border-[#96A480] transition-colors" placeholder="e.g. New, Featured, Best Deal" required>
                @error('name')
